 ...
 * index.html is fully self-contained (fonts, icons, CSS and Leaflet are all
 * embedded), so there are no separate asset files to precache.
...
const API_HOSTS = ['api.frankfurter.app', 'api.open-meteo.com'];
